...
export default function Contactus() {
    ...
    return (
        <>
            ...
            <Container fluid>
                <Container>
                    <h1 className='text-capitalize text-center my-5 pt-3' style={{ fontFamily: "var(--secondary_font)", color: "var(--maroon)" }} data-aos="fade-down"
                        data-aos-offset="300"
                        data-aos-easing="ease-in-sine">contact us</h1>
                    <form action="" className='mb-5' onSubmit={handleContactForm} data-aos="fade-up">
                        <Row>
                            <Col xs={6}>
                                <div>
